...
MEM_0 := experiment3_message_buffer_ram
$(MEM_0)_NAME := message_buffer_ram
...
$(MEM_0)_HIERARCHICAL_PATH := message_buffer_ram
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: message_buffer_ram
message_buffer_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
