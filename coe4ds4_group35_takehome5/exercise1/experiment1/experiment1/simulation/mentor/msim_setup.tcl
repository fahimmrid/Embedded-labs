...
# ACDS 12.0sp2 263 linux 2019.02.28.20:30:56
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_irq_mapper.sv"                     -work experiment1_irq_mapper                                                                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work experiment1_rsp_xbar_mux_001                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_rsp_xbar_mux_001.sv"               -work experiment1_rsp_xbar_mux_001                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work experiment1_rsp_xbar_mux                                                              
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_rsp_xbar_mux.sv"                   -work experiment1_rsp_xbar_mux                                                              
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_rsp_xbar_demux_002.sv"             -work experiment1_rsp_xbar_demux_002                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work experiment1_cmd_xbar_mux                                                              
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_cmd_xbar_mux.sv"                   -work experiment1_cmd_xbar_mux                                                              
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_cmd_xbar_demux_001.sv"             -work experiment1_cmd_xbar_demux_001                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_cmd_xbar_demux.sv"                 -work experiment1_cmd_xbar_demux                                                            
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_id_router_002.sv"                  -work experiment1_id_router_002                                                             
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_id_router.sv"                      -work experiment1_id_router                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_addr_router_001.sv"                -work experiment1_addr_router_001                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/experiment1_addr_router.sv"                    -work experiment1_addr_router                                                               
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                  -work experiment1_cpu_0_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"           -work experiment1_cpu_0_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                 -work experiment1_cpu_0_instruction_master_translator_avalon_universal_master_0_agent       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"             -work experiment1_cpu_0_jtag_debug_module_translator                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"            -work experiment1_cpu_0_instruction_master_translator                                       
  vlog -sv "$QSYS_SIMDIR/submodules/custom_counter_component.sv"                   -work experiment1_custom_counter_component_0                                                
  vlog -sv "$QSYS_SIMDIR/submodules/custom_counter_unit.sv"                        -work experiment1_custom_counter_component_0                                                
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L experiment1_irq_mapper -L experiment1_rsp_xbar_mux_001 -L experiment1_rsp_xbar_mux -L experiment1_rsp_xbar_demux_002 -L experiment1_cmd_xbar_mux -L experiment1_cmd_xbar_demux_001 -L experiment1_cmd_xbar_demux -L experiment1_rst_controller -L experiment1_id_router_002 -L experiment1_id_router -L experiment1_addr_router_001 -L experiment1_addr_router -L experiment1_cpu_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L experiment1_cpu_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L experiment1_cpu_0_instruction_master_translator_avalon_universal_master_0_agent -L experiment1_cpu_0_jtag_debug_module_translator -L experiment1_cpu_0_instruction_master_translator -L experiment1_custom_counter_component_0 -L experiment1_LED_GREEN_O -L experiment1_LED_RED_O -L experiment1_PUSH_BUTTON_I -L experiment1_SWITCH_I -L experiment1_jtag_uart_0 -L experiment1_cpu_0 -L experiment1_onchip_memory2_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
